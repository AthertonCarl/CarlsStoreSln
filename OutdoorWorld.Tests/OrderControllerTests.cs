...
using Moq;
using OutdoorWorld.Controllers;
using OutdoorWorld.Models;
using Xunit;

namespace OutdoorWorld.Tests
{
    public class OrderControllerTests
    {
        ...
        public void Cannot_Checkout_Empty_Cart()
        {
            ...
            // Assert - checl that I am passin an invalid model to the view
        ...
        public void Cannot_Checkout_Invalid_ShippingDetails()
        {
            ...
            // Arrange  - add and error to the model
